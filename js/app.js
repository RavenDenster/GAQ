(() => {
    ...
    function stepForm() {
        const steps = document.querySelectorAll(".screen__item");
        const prevBtn = document.querySelector(".prev__btn");
        const nextBtn = document.querySelector(".next__btn");
        const form = document.querySelector(".steps__form");
        const stepNumbers = document.querySelectorAll(".steps__item");
        const progress = document.querySelector(".steps__success");
        const finishBtn = document.querySelector(".line-finish__btn");
        ...
        function undateFormSteps() {
            ...
            if (0 === formStepIndex) prevBtn.style.display = "none"; else prevBtn.style.display = "block";
            if (formStepIndex === steps.length - 1) {
            ...
            const precent = (actives.length - 1) / (stepNumbers.length - 1) * 100 + "%";
            progress.style.width = precent;
        }
        undateFormSteps();
    }
    if (document.querySelector(".screen__item")) stepForm();
    window["FLS"] = true;
    isWebp();
    formFieldsInit({
        viewPass: false
